...
from isaaclab_assets import HUMANOID_28_CFG, H1_2_CFG, assets_dir # type: ignore
usd_filename = 'usds/h1_2_tabletop_onlyplace.usd'
...
@configclass
class HumanoidOnlyPlaceEnvCfg(DirectRLEnvCfg):
    ...
    apply_delta_action = False
    delta_action_ckpt_path = "logs/rsl_rl/humanoid_operator/2025-05-20_18-39-38/model_3550.pt"

    # payload
    payload: RigidObjectCfg = RigidObjectCfg(
        prim_path="/World/envs/env_.*/task_env/robot/payload",
        spawn=None,
    )
